...
class Roombooking:
    def __init__(self, root):
        ...
        self.var_roomavaiable = StringVar()
        ...
        #txtRoomAvailable = ttk.Entry(labelframeleft, textvariable=self.var_roomavaiable, font=("arial", 13, "bold"), width=29)
        ...
        combo_RoomNo = ttk.Combobox(labelframeleft, textvariable=self.var_roomavaiable, font=("arial", 12, "bold"), width=27, state="readonly")
        ...
        # =======Right-side image==============
        img3 = Image.open(r"C:\Users\SANJANA V PATIL\Downloads\1633410403702hotel-images\hotel images\logohotel.png")
    ...
    def get_cursor(self,event=""):
        ...
        self.var_roomavaiable.set(row[4]),
    ...
    def Fetch_contact(self):
        if self.var_contact.get() == "":
            ...
            if row == None:
                messagebox.showerror("Error", "This number is not found")
            else:
                conn.commit()
                conn.close()
