...
class DetailsRoom:
    def __init__(self, root):
        ...
        # =====================logo===========================
        img2 = Image.open(r"C:\Users\rishi\Desktop\Pesu\DBMS\Project\logo.png")
    ...
    def add_data(self):
        if self.var_floor.get()=="" or self.var_RoomType.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",user="root",password="Rishita2274",database="management")
